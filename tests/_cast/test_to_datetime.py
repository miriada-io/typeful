...
@pytest.mark.parametrize(['value', 'expected'], [
    param("2026-04-02T17:10:01.594503+03:00", datetime.datetime(
        year=2026, month=4, day=2, hour=17, minute=10, second=1, microsecond=594503,
        tzinfo=datetime.timezone(datetime.timedelta(seconds=10800)))),
    param("2026-04-02T17:10:01.594503",
          datetime.datetime(year=2026, month=4, day=2, hour=17, minute=10, second=1, microsecond=594503)),
    param("2026-04-02 17:10:01.594503",
          datetime.datetime(year=2026, month=4, day=2, hour=17, minute=10, second=1, microsecond=594503)),
    ...
    param(1234567890, datetime.datetime(
        year=2009, month=2, day=13, hour=23, minute=31, second=30, tzinfo=datetime.timezone.utc)),
    param(1234567890.123, datetime.datetime(
        year=2009, month=2, day=13, hour=23, minute=31, second=30, microsecond=123000, tzinfo=datetime.timezone.utc)),
