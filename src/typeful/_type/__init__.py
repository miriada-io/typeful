from ._alias import AnnotatedAlias, AnyType, MaybeAnnotated, TypingGenericAlias, WideType, note
from .dataclass_protocol import DataclassProtocol
from .eval_forward_refs import (
    eval_dataclass_fields,
...
from .is_iterable import DEFAULT_BASE_TYPES, ClassInfo, is_iterable
